...
export const learningTickets = [
  ...
  systemTicket({
    ...
    priority: "Highest",
    parentKey: "PRODUCT-216",
    dependencies: ["PRODUCT-220", "PRODUCT-221", "PRODUCT-222", "PRODUCT-223", "PRODUCT-224", "PRODUCT-225", "PRODUCT-226", "PRODUCT-243", "PRODUCT-244", "PRODUCT-245", "PRODUCT-246"],
  ...
  systemTicket({
    key: "PRODUCT-242",
    issueType: "Epic",
    title: "Operationalize CareerOS Learning & Delivery for real use",
    publicSummary: "Make the authenticated Learning & Delivery system reliable, current, searchable, and easy to navigate before real SQL execution begins.",
    deliveryStatus: "In Progress",
    evidenceState: "Practicing",
    priority: "Highest",
    parentKey: "PRODUCT-216",
    dependencies: ["PRODUCT-240"],
    actualStart: "2026-08-08",
    definitionOfDone: "Jason can authenticate through a persisted session or registered passkey, mutate canonical tickets durably, search and navigate delivery work, and see approved state across every dependent public surface.",
    acceptanceCriteria: ["Persisted session and passkey access", "Durable canonical ticket reconciliation", "Searchable Learning delivery workspace", "Interactive delivery timeline"],
    capabilitySlugs: ["delivery-modeling", "privacy-review", "testing", "accessibility", "responsive-design"],
    evidenceIds: [],
    nextAction: "Complete PRODUCT-243 and its production passkey enrollment gate before beginning PRODUCT-244 through PRODUCT-246.",
    notClaimed: "This epic does not implement PRODUCT-241, public ticket intake, password authentication, provider scraping, or historical learning-effectiveness claims.",
  }),
  systemTicket({
    key: "PRODUCT-243",
    issueType: "Story",
    title: "Add passkey-first admin access and redirect continuity",
    publicSummary: "Add passkey-first re-entry, preserve email recovery, and return authorized sessions only to validated internal CareerOS destinations.",
    deliveryStatus: "In Review",
    evidenceState: "Practicing",
    priority: "Highest",
    ...
    dependencies: ["PRODUCT-220"],
    actualStart: "2026-08-08",
    definitionOfDone: "A persisted session or registered production passkey reaches the intended safe route only after immutable administrator-membership authorization, while Magic Link recovery and local sign-out remain available.",
    acceptanceCriteria: ["Experimental passkey client opt-in", "Passkey registration and management", "Same-origin return path validation", "Production enrollment and recovery verification"],
    capabilitySlugs: ["privacy-review", "testing", "accessibility", "responsive-design"],
    evidenceIds: [],
    nextAction: "Review PR A, enroll one passkey on the canonical production origin, then verify sign-out, passkey re-entry, authorization, return continuity, and email recovery.",
    notClaimed: "Unit tests and preview UI do not prove that a production passkey has been registered or used successfully.",
  }),
  systemTicket({
    key: "PRODUCT-244",
    issueType: "Story",
    title: "Reconcile durable ticket state and derived public surfaces",
    publicSummary: "Make every Learning-derived surface use the same approved public snapshot and reconcile verified implementation through audited admin mutations.",
    deliveryStatus: "Ready",
    evidenceState: "Planned",
    priority: "Highest",
    parentKey: "PRODUCT-242",
    dependencies: ["PRODUCT-243"],
    definitionOfDone: "Canonical durable state, approved projection, shared selectors, reload persistence, and dependent public views agree after one truthful reversible production mutation.",
    acceptanceCriteria: ["Shared snapshot selectors", "Reviewed closure checklist", "Audited mutation and projection refresh", "Reload and reversal verification"],
    capabilitySlugs: ["delivery-modeling", "privacy-review", "testing"],
    evidenceIds: [],
    nextAction: "Begin only after PRODUCT-243 clears its authentication and recovery gate.",
    notClaimed: "Checked-in fallback changes do not overwrite or reconcile existing durable rows.",
  }),
  systemTicket({
    key: "PRODUCT-245",
    issueType: "Story",
    title: "Create a dedicated searchable Learning Delivery workspace",
    publicSummary: "Focus the Learning overview and make the canonical board searchable and easier to navigate without creating another tracker.",
    deliveryStatus: "Ready",
    evidenceState: "Planned",
    priority: "High",
    parentKey: "PRODUCT-242",
    dependencies: ["PRODUCT-244"],
    definitionOfDone: "Learning subnavigation, compact overview, recent approved evidence, URL-backed ticket search, and safe filtered-board movement all use canonical public records.",
    acceptanceCriteria: ["Learning-local navigation", "Reduced overview", "Dynamic recent evidence", "Shareable ticket search", "Filtered-board rank safety"],
    capabilitySlugs: ["delivery-modeling", "evidence-design", "accessibility", "responsive-design"],
    evidenceIds: [],
    nextAction: "Implement in PR B after canonical snapshot reconciliation is verified.",
    notClaimed: "This story does not create a second board, search private notes, or label course enrollment as Backlog.",
  }),
  systemTicket({
    key: "PRODUCT-246",
    issueType: "Story",
    title: "Add interactive timeline-kind filters and clickable delivery rows",
    publicSummary: "Add URL-backed timeline-kind filters and accessible ticket links while keeping existing schedule semantics canonical.",
    deliveryStatus: "Ready",
    evidenceState: "Planned",
    priority: "High",
    parentKey: "PRODUCT-242",
    dependencies: ["PRODUCT-244", "PRODUCT-245"],
    definitionOfDone: "Planned, actual, open, and completed timeline kinds filter shareably and each delivery row has a semantic ticket-detail destination.",
    acceptanceCriteria: ["Interactive kind legend", "Combined URL filters", "Clickable rows and text links", "Roadmap freshness audit"],
    capabilitySlugs: ["delivery-modeling", "accessibility", "responsive-design", "testing"],
    evidenceIds: [],
    nextAction: "Implement with PRODUCT-244 and PRODUCT-245 in PR B after PR A acceptance.",
    notClaimed: "No new timeline derivation, burn chart, or unsupported completion claim is introduced.",
  }),
  systemTicket({
    key: "PRODUCT-247",
    issueType: "Spike",
    title: "Evaluate truthful historical learning-flow analytics",
    publicSummary: "Determine whether canonical source history can support cumulative completions, scope change, cycle-time, course, and evidence-publication trends.",
    deliveryStatus: "Backlog",
    evidenceState: "Planned",
    priority: "Low",
    parentKey: "PRODUCT-242",
    dependencies: ["PRODUCT-244", "PRODUCT-246"],
    definitionOfDone: "Available historical snapshots are inventoried and any missing source history becomes an explicit future capture requirement rather than reconstructed data.",
    acceptanceCriteria: ["Historical source inventory", "Scope-change feasibility", "Trend definitions", "Future snapshot requirement when history is absent"],
    capabilitySlugs: ["delivery-modeling", "evidence-design", "privacy-review"],
    evidenceIds: [],
    nextAction: "Evaluate only after operational state and timeline semantics are stable.",
    notClaimed: "Completion timestamps alone do not establish a truthful historical scope series or learning effectiveness.",
  }),
  systemTicket({
    key: "PRODUCT-248",
    issueType: "Story",
    title: "Add moderated public feature-request and defect intake",
    publicSummary: "Evaluate a moderated public submission path that creates review candidates rather than canonical tickets.",
    deliveryStatus: "Backlog",
    evidenceState: "Planned",
    priority: "Low",
    parentKey: "PRODUCT-242",
    dependencies: ["PRODUCT-245"],
    definitionOfDone: "A cost-reviewed design covers moderation, spam protection, rate limits, validation, privacy, stable conversion keys, and audit history without public direct ticket creation.",
    acceptanceCriteria: ["Moderation candidate boundary", "Spam and rate-limit design", "Privacy notice", "Manual accept/reject conversion", "Cost review"],
    capabilitySlugs: ["privacy-review", "delivery-modeling", "testing"],
    evidenceIds: [],
    nextAction: "Keep public intake deferred until the authenticated single-admin workflow is operationally stable.",
